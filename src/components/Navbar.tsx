          ...
          <div className="mobile-menu block md:hidden">
            {!navbarOpen ? (
              <button
                ...
                className="flex items-center px-2.5 py-1.5 sm:px-3 sm:py-2 border-2 rounded-lg border-luxury-gold/50 text-luxury-platinum hover:text-luxury-gold hover:border-luxury-gold transition-all duration-300 hover:bg-luxury-gold/10"
              >
              ...
              <button
                ...
                className="flex items-center px-2.5 py-1.5 sm:px-3 sm:py-2 border-2 rounded-lg border-luxury-gold/50 text-luxury-gold hover:text-luxury-platinum hover:border-luxury-platinum transition-all duration-300 hover:bg-luxury-gold/10"
              >
