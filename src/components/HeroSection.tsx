...
export default function HeroSection() {
  return (
    <section className="min-h-[60vh] flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-32 mt-16 sm:mt-20 md:mt-26">
      ...
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 leading-tight text-white courier-prime-bold">
        BUILD WITH <br />
      ...
      <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center w-full max-w-md sm:max-w-none px-4">
        ...
        >
          ...
          <span className="absolute -inset-1 border-2 border-luxury-gold bg-luxury-gold opacity-0 group-hover:opacity-100 transition-all duration-500 rounded-full"></span>
        </a>

        <a
          href="#contact"
          className="relative bg-transparent border border-luxury-gold/10 text-white font-semibold px-8 sm:px-10 py-2.5 sm:py-3 rounded-full shadow-lg hover:bg-luxury-gold/20 hover:scale-105 transition-all duration-500 group text-sm sm:text-base"
        >
          <span className="relative z-10">About Me</span>
          <span className="absolute -inset-0.5 border border-luxury-gold opacity-0 group-hover:opacity-100 transition-all duration-500 rounded-full"></span>
        </a>
      </div>
    </section>
  );
